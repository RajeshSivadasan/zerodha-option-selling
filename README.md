...
(Refer to <a href="https://github.com/RajeshSivadasan/zerodha-option-selling/blob/main/test.md">.ini configuration help</a> for detailed description and usage of the settings) 
